...
- [x] **B24f** Class expression private methods / private accessors — sync ◐ / res ☑ ✅ (Codex): resumable routing now conditionally admits `LoadClassLiteral` only for class literals with private instance methods/accessors and no extends, fields, static blocks/elements, static members, computed members, or public members; neighboring B24 leaves remain declined by the class-literal shape predicate.
