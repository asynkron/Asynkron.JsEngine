...
_Checklist status: 96 / 145 complete. The latest B23 slice admitted generator nested function literals that capture root body locals via a materialized resumable body environment. B23 remains partial for async captured literals and lexical/private closure contexts; B36 remains partial for capturing declarations, recursive/sibling helper graphs, block/Annex B declarations, and class declarations. The resumable opcode gap inventory remains 19 and the instruction gap inventory remains 9._
