...
33. Preserve the unified bytecode prototype control-flow boundary proven in [#2182](https://github.com/asynkron/Asynkron.JsEngine/issues/2182): branch shapes plus one canonical guarded `while` back-edge stay accepted, while other loop/control-flow families remain explicitly declined under ADR 0192.
