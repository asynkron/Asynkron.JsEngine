...
50. When admitting class literals or other closure/environment-dependent value
    ...
    unproven fields, static elements/blocks, private computed members, and
    `extends` expressions that read resumable activation slots as pre-VM declines
    until the VM owns those class-definition environment semantics. Do
