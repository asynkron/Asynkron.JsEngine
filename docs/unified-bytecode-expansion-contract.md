...
- The remaining coarse P0.4 leaves are decomposed under
  ...
  through the materialized body-environment route, and non-static,
  non-computed private instance fields under the same activation-safety rules,
  and
  ...
  static/computed member state, static-block environment state, and
...
body-environment route, and non-static, non-computed private instance fields
under the same activation-safety rules, plus public
