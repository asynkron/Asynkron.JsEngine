...
- Current executable call support covers
  ...
  simple array/object/template literal values or elements (`{items: [a, b]}`,
  `[{x}]`, ``{label: `hello ${name}`}``) and object literal spread entries
