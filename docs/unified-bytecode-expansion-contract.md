...
| `A51b` | Activation-slot metadata, slot-layout, declaration / assignment / update storage targets, and iterator/for-in TDZ-head flat-slot mapping | Existing execution-plan runner | both |
