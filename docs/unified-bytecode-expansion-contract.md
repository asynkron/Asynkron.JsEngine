...
- `A51f5:PrivateNeighborExpressionLoop` - narrowed. Plain private named reads
  now route as simple value operands in binary/RHS spans. Private named deletes,
  optional/private receiver-neighbor reads, private receiver-neighbor mutation
  or call shapes, and private super/member call neighbors stay declined until
  those exact private-adjacent routes are VM-owned.
