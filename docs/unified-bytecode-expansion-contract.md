...
| `A51j` | Property write, compound/logical write, update, delete, name-inference, key-span, and RHS-span shapes; one-hop private receiver-prefix public named/computed update terminals now route, while deeper private-prefix update chains and compound/logical/private-terminal mutation neighbors remain gated | Existing expression-program mutation evaluation | both |
