...
| `A51c` | Catch binding, lexical dynamic declaration, active-with dynamic-name, and non-flat scope/environment TDZ-head binding storage | Existing environment-aware execution-plan runner | both |
