...
- Current executable call support covers
  ...
  simple array/object literal values or elements (`{items: [a, b]}`, `[{x}]`)
  and object literal spread entries whose spread source is a simple operand
