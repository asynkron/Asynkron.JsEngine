...
slides[50] = "ir-architecture-only.svg";
slides[51] = "almost-done-devil.svg";
slides[52] = "make-the-real-thing-architecture.svg";
slides[53] = "execution-model-overview.svg";
slides[54] = "bytecode-stack-machine.svg";
slides[55] = "what-about-quality.svg";
slides[56] = "code-quality-survival-kit.svg";
slides[57] = "quickdup-duplication-radar.svg";
slides[58] = "demo-time.svg";
slides[59] = "node-shaped-boundary-framing.svg";
slides[60] = "express-live-demo.svg";
slides[61] = "express-demo-stack.svg";
slides[62] = "runtime-journey-pattern.svg";
slides[63] = "jsengine-presentation-reveal.svg";
slides[64] = "how-far-did-we-push-it.svg";
