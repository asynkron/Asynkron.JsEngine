...
## Dependency baseline note (2026-06-13 signal)

The real Express package demo now uses the current stable Express line. On
2026-06-13, `npm view express version dist-tags.latest` reported `5.2.1`.
...
range target and `latest`. On the same 2026-06-13 signal,
