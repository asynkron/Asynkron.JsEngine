...
## Dependency drift note (2026-05-22 signal)

The demo intentionally stays on the Express 4 line for now. On 2026-05-22,
...
range target and `latest`. On the same 2026-05-22 signal,
