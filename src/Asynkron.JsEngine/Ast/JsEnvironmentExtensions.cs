...
{
    private static bool IsGeneratorContext(this JsEnvironment environment)
    {
        return environment.TryGetObject<YieldResumeContext>(Symbol.YieldResumeContextSymbol, out _);
    }

    private static GeneratorPendingCompletion GetGeneratorPendingCompletion(this JsEnvironment environment)
    {
    ...
    private static void EnsureFunctionScopedVarBinding(this JsEnvironment environment, Symbol name,
