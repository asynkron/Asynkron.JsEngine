...
public static partial class TypedAstEvaluator
{
    private sealed partial class ExecutionPlanRunner
    {
        ...
        [MethodImpl(JsEngineConstants.Inlining)]
        private static InstructionResult HandleSuspendingLogicalCompoundAssignmentSlot(
            ExecutionPlanRunner runner,
            ExecutionInstruction instr,
            ref JsEnvironment environment,
            EvaluationContext context,
            out JsValue returnValue)
        {
            var instruction = Unsafe.As<SuspendingLogicalCompoundAssignmentSlotInstruction>(instr);
            var variable = FlatSlotAccessor.Create(runner, instruction.FlatSlotId);
            var useFlatSlot = variable.UseFlatSlot;
            ...
            out JsValue returnValue)
        {
            ...
            return HandleCompoundAssignmentSlotSlow(
                runner,
                instruction,
                flatSlotId,
                ref environment,
        ...
        [MethodImpl(JsEngineConstants.Inlining)]
        private static InstructionResult HandleSuspendingCompoundAssignmentSlot(
            ExecutionPlanRunner runner,
            ExecutionInstruction instr,
            ref JsEnvironment environment,
            EvaluationContext context,
            out JsValue returnValue)
        {
            var instruction = Unsafe.As<SuspendingCompoundAssignmentSlotInstruction>(instr);
            return HandleSuspendingCompoundAssignmentSlotSlow(
                runner,
                instruction,
                instruction.FlatSlotId,
                ref environment,
                context,
                out returnValue);
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static InstructionResult HandleSuspendingCompoundAssignmentSlotSlow(
            ExecutionPlanRunner runner,
            SuspendingCompoundAssignmentSlotInstruction instruction,
            int flatSlotId,
            ref JsEnvironment environment,
            EvaluationContext context,
            out JsValue returnValue)
        {
            ...
            var compRhsValue = ProfileEvaluateExpression(instruction.RhsExpression, environment, context);
