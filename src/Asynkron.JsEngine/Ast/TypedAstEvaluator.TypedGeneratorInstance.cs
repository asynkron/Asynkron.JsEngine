                        ...
                        switch (instruction)
                        {
                            case StatementInstruction statementInstruction:
                                ...
                                if (context.IsYield)
                                {
                                    ...
                                    return JsValue.FromObjectUnsafe(iteratorResultObject ??
                            ...
                            case YieldInstruction yieldInstruction:
                                ...
                                if (yieldInstruction.YieldExpression is not null)
                                {
                                    ...
                                    if (context.IsYield)
                                    {
                                        ...
                                        RecordYield(context);
                                        _state = GeneratorState.Suspended;
                                        return JsValue.FromObjectUnsafe(nestedIteratorResult ??
                                ...
                                while (true)
                                {
                                    ...
                                    if (iteratorResult.IsDelegatedCompletion)
                                    {
                                        ...
                                        if (!iteratorResult.Done)
                                        {
                                            ...
                                            return JsValue.FromObjectUnsafe(iteratorResult.IteratorResultObject ??
                                                                            CreateIteratorResult(iteratorResult.Value,
                                                                                false));
                                        }
