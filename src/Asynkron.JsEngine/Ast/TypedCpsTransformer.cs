...
public sealed class TypedCpsTransformer
{
    ...
    private StatementNode EnsureResolvedReturn(StatementNode statement)
    {
        switch (statement)
        {
            case ReturnStatement returnStatement:
                ...
                var expression = returnStatement.Expression ?? new IdentifierExpression(null, Symbol.Undefined);
        ...
        Symbol? rejectOverride = null)
    {
        ...
        public ImmutableArray<StatementNode> Rewrite(ImmutableArray<StatementNode> statements)
        {
            ...
            {
                var undefinedValue = new IdentifierExpression(null, Symbol.Undefined);
            ...
            switch (statement)
            {
                case ReturnStatement returnStatement:
                    var returnExpression =
                        returnStatement.Expression ?? new IdentifierExpression(null, Symbol.Undefined);
