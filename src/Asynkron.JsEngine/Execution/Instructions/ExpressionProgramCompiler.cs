...
internal static class ExpressionProgramCompiler
{
        ...
        string? failureReason)
    {
        ...
        var code = detail switch
        {
            ...
            "Expression bytecode only supports static dot-access property names for direct member calls."
        ...
        out string? failureReason)
    {
        ...
        switch (expression.Callee)
        {
            ...
            case MemberExpression { Target: SuperExpression, IsComputed: false } member:
                ...
                {
                    failureReason = "Expression bytecode only supports static dot-access property names for direct member calls.";
                    return false;
                }
