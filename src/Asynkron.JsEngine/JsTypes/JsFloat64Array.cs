...
/// </summary>
public sealed class JsFloat64Array(JsArrayBuffer buffer, int byteOffset, int length, bool isLengthTracking = false)
    : TypedArrayBase(buffer, byteOffset, length, BYTES_PER_ELEMENT, isLengthTracking)
{
    ...
    public static JsFloat64Array FromArray(JsArray array, RealmState? realmState = null)
    {
