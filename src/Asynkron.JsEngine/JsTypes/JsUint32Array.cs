...
/// </summary>
public sealed class JsUint32Array(JsArrayBuffer buffer, int byteOffset, int length, bool isLengthTracking = false)
    : TypedArrayBase(buffer, byteOffset, length, BYTES_PER_ELEMENT, isLengthTracking)
{
    ...
    public override void SetElement(int index, double value)
    {
        ...
        BinaryPrimitives.WriteUInt32LittleEndian(span, uint32Value);
    }
    ...
    {
        return new JsUint32Array(buffer, byteOffset, length);
    }
}
