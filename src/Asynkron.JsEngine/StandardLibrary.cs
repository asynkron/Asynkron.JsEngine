...
public static class StandardLibrary
{
    ...
    public static JsObject CreateMathObject()
    {
        ...
        {
            var number = args.Count > 0 ? JsExpressionEvaluator.ToNumber(args[0]) : 0d;
        ...
        {
            var left = args.Count > 0 ? JsExpressionEvaluator.ToNumber(args[0]) : 0d;
            var right = args.Count > 1 ? JsExpressionEvaluator.ToNumber(args[1]) : 0d;
    ...
    public static void AddArrayMethods(JsArray array)
    {
        ...
        array.SetProperty("join", new HostFunction((thisValue, args) =>
        {
            ...
            {
                parts.Add(JsExpressionEvaluator.ToJsStringForArray(item));
            }
