        ...
        RealmState realm) where T : TypedArrayBase
    {
        ...
        prototype.SetHostedProperty("reduce",
            (thisValue, reduceArgs, realmState) =>
                TypedArrayReduceInternal(thisValue, reduceArgs, realmState, "%TypedArray%.prototype.reduce", false),
            realm);
        prototype.SetHostedProperty("reduceRight",
            (thisValue, reduceArgs, realmState) =>
                TypedArrayReduceInternal(thisValue, reduceArgs, realmState, "%TypedArray%.prototype.reduceRight",
                    true),
            realm);
