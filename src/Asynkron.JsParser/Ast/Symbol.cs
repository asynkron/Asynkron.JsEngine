...
/// <summary>
/// Interned symbol for identifier names. Symbols are compared by reference for performance.
/// </summary>
public sealed class Symbol : IEquatable<Symbol>
{
    ...
    // Core symbols needed by the parser
    ...
    /// <summary>
    /// Creates a new unique symbol (not interned). Used for runtime Symbol() values.
    /// </summary>
