...
{
    private const string EnabledEnvVar = "JSENGINE_TRACE_ACTIVITY";

    private static readonly bool IsEnabled =
        !string.IsNullOrEmpty(Environment.GetEnvironmentVariable(EnabledEnvVar));
