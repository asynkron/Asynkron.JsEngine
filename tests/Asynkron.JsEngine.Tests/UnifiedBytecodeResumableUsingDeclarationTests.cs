...
/// <summary>
///     Proof pack for direct function-body sync <c>using</c> declarations on the resumable unified-bytecode
///     route. The resource registers through <see cref="UnifiedBytecodeOpCode.RegisterDisposable" /> against
///     the materialized resumable body environment and is disposed when the frame completes or throws.
