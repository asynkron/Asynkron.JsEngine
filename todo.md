...
IMPORTANT:
Once you are done, give up, make sure to create a pull request to github!
Successful fixes, or just docmenting or increased testcoverage even when giving up should be sent as a PR.
